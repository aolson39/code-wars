...
//raised to the power of the number of digits in a given base. In this Kata, we will restrict ourselves to decimal 
//(base 10).
...
function narcissistic(value) {
    ...
    let arr = (""+value).split("")
    return arr.reduce((acc, element) => acc +element ** arr.length, 0)
  }
